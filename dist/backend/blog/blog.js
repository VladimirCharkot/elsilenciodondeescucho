...
exports.traer_texto = exports.buscar = exports.buscar_texto = exports.indice_textos_public = exports.frontend = exports.hogar = exports.colecta = void 0;
const lodash_1 = require("lodash");
const mdesde_1 = require("./mdesde");
const mdcustoms_1 = require("./mdcustoms");
...
const frontend = async (__, res) => {
    res.render('frontend');
};
exports.frontend = frontend;
// Geteados por el frontend: 
const indice_textos_public = async (__, res) => {
    const idx = (0, lodash_1.cloneDeep)(cache_1.cache_textos ? cache_1.cache_textos.filter(txt => (txt.fm ? !txt.fm.oculto || txt.fm.oculto == "no" : true) && txt.link.includes('escritos')) : []);
...
const traer_texto = async (textoId) => {
    ...
    try {
        ...
        return { html: (0, mdcustoms_1.corregir_imagenes)(new jsdom_1.JSDOM(html).window.document), front_matter };
    }
    catch (e) {
